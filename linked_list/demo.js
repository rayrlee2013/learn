...
//查找节点
LList.prototype.find = function (tarNode) {
...
//查找当前节点前一个节点
LList.prototype.findPrev = function (value) {
    let node = this.head;
...
LList.prototype.insert = function (node, pos) {
...
LList.prototype.append = function () {
